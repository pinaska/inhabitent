...
function inhabitent_register_product() {
	...
	$args = array(
		'label'                 => 'Product',
		'description'           => 'Products are things Camping Co. sells',
		'labels'                => $labels,
...
//paste your adventre custom post type code
// Register Custom Post Type
function inhabitent_register_adventure() {
	...
	$args = array(
		'label'                 => 'Adventure',
		'description'           => 'Adventures are story about Inhabitent products and people',
		'labels'                => $labels,
