 ...
 * @author    KAte <email@example.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2018 Kate Jeziorska #kasiaikod
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        https://github/pinaska/inhabitent
 * Description:       A  niffty business hours widget
 * Version:           1.0.0
 * Author:            Kate
 * Author URI:       	https://github.com/pinaska/inhabitent
 * License:           GPL-2.0+
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Add the store buisness hours.'
			)
		);
