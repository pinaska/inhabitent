...
?>
			...
			<footer id="colophon" class="site-footer" role="contentinfo">
				...
				<a href="<?php echo home_url() ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/inhabitent-logo-text.svg" alt="Inhabitent logo"/></a>
				</div><!--end of footer-logo-->
				</div><!--end of footer widget area-->

				<div class="footer-copyright">
				<a href="<?php echo home_url() ?>"><?php printf( esc_html( 'Copyright &#169; 2017 Inhabitent' ), 'WordPress' ); ?></a>
